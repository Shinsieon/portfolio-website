...
1. 빠른 검색
   ...
   1. 창세기 1장 2절을 검색하기 위해선 "창 1 2" 를 검색하면 됩니다.
   1. 창세기 1장을 검색하기 위해선 "창 1" 만 검색하면 됩니다.

1. 즐겨찾기

   1. 미리 성경을 즐겨찾기에 등록해놓아 빠르게 찾을 수 있습니다.
   2. 더블클릭 시 즐겨찾기 목록에서 제거됩니다.

1. Left 키와 Right 키로 이전 구절 다음 구절 제어가 가능합니다.

1. 출력할 모니터 선택
   1. 연결되어 있는 모니터를 탐색 후 출력 가능한 모니터 중 선택해서 띄울 수 있습니다.
